...
<script type="text/javascript">
	...
	function loadPage() {
		...
		author_id = Number(getQueryString("author_id"));
		//获取详情
			$.ajax({
			url : "webctrl/getPoem",
			dataType : "json",
			...
			success : function(data) {
				...
				var path = "../../res/assets/img/model/"+data.url;
	...
	function addModel(){
			$("#save").on("click",function(){
	        	...
	        	if($("#front_fileName").val() === ""){
	        		layer.msg("请上传照片",2,{type : 1,shade : false});
	            ...
	            $.ajax({
	                url:"webctrl/updatePoem",
	                type:"POST",
	                dataType:"json",
	                data:{
	                	id : idVar,
	                	author_id : $("#made_type").find("option:selected").val(),
									...
									<div class="span4">
										<form class="form-horizontal" id="adsForm">
											<div class="form-group">
												<label class="col-sm-2 control-label" for="made_type">作者</label>
												<div class="col-sm-10">
